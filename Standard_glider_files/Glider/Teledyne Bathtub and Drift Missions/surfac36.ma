...
# Come up every X amount of seconds (regardless of when we last had comms)

<start:b_arg>

    b_arg: start_when(enum)         12 		  # BAW_NO_COMMS =12 ; BAW_EVERY_SECS = 9, every 'when_secs'

    b_arg: when_secs(s)             46800         # 46800 = 13hrs;
